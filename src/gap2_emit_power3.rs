...
use crate::gap2_tail_power_v::{lemma_power_block_step_block3_tail_safe_v, lemma_power_block_step_block3_m1_tail_safe_v};
verus! {
...
// ─────────────────────────────────────────────────────────────────────────────
// v-side (α-tail) companions — mirror of the u-side pbb3x phase tail_safe lemmas.
// ─────────────────────────────────────────────────────────────────────────────

pub proof fn lemma_pbb3x_phase_tail_safe_v(tm: Tm, len: nat, pc: nat, big_m: nat, g: nat, od: Seq<nat>,
    s0: nat, s1: nat, s2: nat, qexit: nat, h: nat)
    requires
        tm_wf(tm),
        tm.n == 5,
        tm.m == tm_mod5(len),
            ...
            == h,
{
    ...
    // ── invoke the verified triple power-block step (q_dh0 = e, q_exit = qexit external). ──
    lemma_power_block_step_block3_tail_safe_v(tm, big_m, g, od, s0, s1, s2,
        e + 0, e + 1, e + 2, e + 3, e + 4, e + 5, e + 6,
        e + 7, e + 8, e + 9, e + 10, e + 11, e + 12, e + 13, e + 14,
        e + 15, e + 16, e + 17,
        e + 18, e + 19, e + 20, e + 21, e + 22, e + 23,
...
pub proof fn lemma_pbb3x_m1_phase_tail_safe_v(tm: Tm, len: nat, pc: nat, g: nat, od: Seq<nat>,
    s0: nat, s1: nat, s2: nat, qexit: nat, h: nat)
    requires
        tm_wf(tm),
        tm.n == 5,
            ...
            == h,
{
    ...
    // ── invoke the verified M=1 triple power-block step (q_dh0 = e, q_exit = qexit external). ──
    lemma_power_block_step_block3_m1_tail_safe_v(tm, g, od, s0, s1, s2,
        e + 0, e + 1, e + 2, e + 3, e + 4, e + 5, e + 6,
        e + 8, e + 9, e + 10, e + 15, e + 16, e + 17, e + 7,
        e + 18, e + 19, e + 20, e + 21, e + 22, e + 23,
        e + 24, e + 25, e + 26, e + 27, e + 28, e + 29, e + 30, e + 31, e + 32, qexit,
...
pub proof fn lemma_pbb3x_phase_any_tail_safe_v(tm: Tm, len: nat, pc: nat, big_m: nat, g: nat, od: Seq<nat>,
    s0: nat, s1: nat, s2: nat, qexit: nat, h: nat)
    requires
        tm_wf(tm),
        tm.n == 5,
...
{
    if big_m == 1 {
        lemma_pbb3x_m1_phase_tail_safe_v(tm, len, pc, g, od, s0, s1, s2, qexit, h);
    } else {
        lemma_pbb3x_phase_tail_safe_v(tm, len, pc, big_m, g, od, s0, s1, s2, qexit, h);
    }
}
